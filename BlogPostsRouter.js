...
BlogPosts.create('Blog Post 1', 'This is a very interesting blog about topic 1', 'Bob Smith');
BlogPosts.create('Blog Post 2', 'Even more interesting blog than topic 1.  Its all about topic 2','John Doe');
BlogPosts.create('Blog Post 3', 'This blog is absolutely amazing. It has all the answers', 'Frank N. Beans');
